...
import { InactiveAppState } from "@/components/app/InactiveAppState";
...
import { BrandBuildView } from "@/features/app/components/BrandBuildView";
...
export default async function BrandBrainRoadmapPage({
  ...
  const { user, profile } = await requireUserProfile("/brand-integrated-brain/roadmap");
