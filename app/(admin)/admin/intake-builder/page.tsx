...
export const metadata: Metadata = {
  title: "Intake Builder | Bextudio Admin",
};
    ...
    <div className="space-y-4 rounded-lg border border-destructive/40 bg-card p-4 text-sm leading-6">
      <div>
        <h2 className="text-lg font-semibold text-destructive">
          Intake Builder migration is required
        </h2>
...
export default async function AdminIntakeBuilderPage() {
  const { user, profile } = await requirePlatformOwner("/admin/intake-builder");
  let data = null;
