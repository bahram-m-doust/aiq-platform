...
export function InactiveAppState({
  email,
  initialRawKey,
  signOutAction,
}: {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Inactive Workspace</CardTitle>
